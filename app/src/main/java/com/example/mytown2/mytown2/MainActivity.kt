package com.example.mytown2.mytown2
...
import com.example.mytown2.R
import com.example.mytown2.Location
...
//        val text = FileHelper.getTextFromResources(app, R.raw.monster_data)
    ...
    fun setRecyclerView() {
        ...
        //specify fav icons
        val drawableFav: Drawable? = ResourcesCompat.getDrawable(resources,
            R.drawable.ic_heart_fav, null)
        val drawable: Drawable? = ResourcesCompat.getDrawable(resources, R.drawable.ic_heart, null)

        // specify an adapter
        val mAdapter = com.example.mytown2.RecyclerViewAdapter(
